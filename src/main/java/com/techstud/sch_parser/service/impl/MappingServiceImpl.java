...
public class MappingServiceImpl implements MappingService {
     ...
     */
    public List<DayOfWeek> returnMissingDayOfTheWeek(List<DayOfWeek> actualWeekList){
     ...
     */
    public ScheduleType returnScheduleTypeSpbstu(String spbstuType){
        Map<String, ScheduleType> scheduleTypeMap = Map.of(
                "Лекции", ScheduleType.LECTURE,
     ...
     */
    public JsonNode returnJsonNodeFromResponseSpbstu(Elements elementsHTMLResponse){
     ...
     */
    public List<ScheduleDay> returnObjectParsingListFromResponseSpbstu(JsonNode responseFromHTML){
     ...
     */
    public Map<DayOfWeek, ScheduleDay> returnScheduleDayListFromResponseSpbstu(Document documentResponse){
